...
- **(c) Signal shift with ff\_rate\_matched recovers to near-raw levels.** Stall drops to 0.24\% and 0.29\% — below the raw-ASAP baseline — confirming that ff\_rate\_matched eliminates stall regression and completes the signal shift optimization.
