...
def test_shifted_study_outputs(tmp_path: Path) -> None:
    ...
    assert any(e["width_profile"] == "W8_M8_F8" for e in outputs.paired_seed_effects)
    ...
    assert win_rows[("shifted", "TESTB", "greedy_critical", "W8_M8_F4")]["throughput_win_count"] == 1
    assert win_rows[("shifted", "TESTB", "asap", "W8_M8_F8")]["throughput_win_count"] == 1
