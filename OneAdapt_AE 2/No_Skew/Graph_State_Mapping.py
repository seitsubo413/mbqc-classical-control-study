...
from No_Skew.Construct_Test_Circuit import *
from No_Skew.Graph_State import *
from No_Skew.Mapping_Routing_origin import *
from No_Skew.Determine_Dependency import *
...
def graph_state_mapping(N_size, NQubit, algorithm_type, Refresh, RefreshBound, D_Flag, Braiding, P_const):
    empty_folder("layers/")
    ...
    # map & route
    net_list, layer_index, layer_list, left_graph_nodes_list, inter_edges_list, refresh_begin_list, refresh_end_list, required_life_time, swap_map = map_route(algorithm_type, lgs, dgraph, NQubit, N_size, Refresh, RefreshBound, D_Flag, Braiding, P_const)
    ...
    return inter_edges_list, layer_index, refresh_begin_list, refresh_end_list, required_life_time, swap_map
